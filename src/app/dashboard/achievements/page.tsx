        ...
        <div className="md:col-span-2 space-y-8">
          <Card className="border-none shadow-sm bg-card overflow-hidden">
            <CardHeader className="bg-accent/5">
              <CardTitle>{t('rankSystem')}</CardTitle>
              <CardDescription>{t('howToAdvance')}</CardDescription>
            </CardHeader>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {l.level === currentLevel && <Badge className="text-[10px] bg-accent text-accent-foreground">Current</Badge>}
                        </div>
              ...
              <div className="bg-muted/30 p-6 rounded-2xl border space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-sm font-bold">{t('todayFocus')}</p>
                    <p className="text-xs text-muted-foreground">{t('focusHoursExp')}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-bold">{t('dailyMilestone')}</p>
                    <p className="text-xs text-muted-foreground">{t('goalCompletionExp')}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-bold">{t('weeklyTrends')}</p>
                    <p className="text-xs text-muted-foreground">{t('dailyStreaksExp')}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-bold">{t('groups')}</p>
                    <p className="text-xs text-muted-foreground">{t('groupMilestonesExp')}</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-none shadow-sm bg-card">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground italic">{t('approxUntilNext')}</p>
              </div>
            </CardContent>
          </Card>
